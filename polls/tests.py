...
class QuestionMethodTests(TestCase):
    ...
    def test_was_published_recently_with_future_question(self):
        """
        was_published_recently() should return False for questions whose pub-date
        is in the future.
        """
    ...
    def test_was_published_recently_with_recent_question(self):
        """
        was_published_recently() should return True for questions whose pub-date
...
class QuestionViewTests(TestCase):
    ...
    def text_index_view_with_a_past_question(self):
        """
        Questions with a pub_date in the past should not be displayed on the
        index
        """
...
class QuestionIndexDetailTests(TestCase):
    def test_detail_view_with_a_future_question(TestCase):
